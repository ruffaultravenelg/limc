Namespace AST
    Public Class StructConstruct
        ...
        Public Sub New(Name As String, GenericTypeNames As IEnumerable(Of String), Fields As IEnumerable(Of Field), Methods As IEnumerable(Of FunctionConstruct), Location As Location)
            MyBase.New(Location)
            Me.Name = Name
        ...
        Public Function InstanciateType(GenericTypes As IEnumerable(Of TypeSystem.Type)) As TypeSystem.Type Implements IGenerateType.InstanciateType
            Return New TypeSystem.StructType(Me, GenericTypes)
        End Function
